...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto no-scrollbar group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
