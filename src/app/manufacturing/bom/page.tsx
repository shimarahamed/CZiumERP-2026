...
function BillOfMaterialsPageInner() {
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <Breadcrumb items={[{ label: 'Manufacturing', href: '/manufacturing/bom' }, { label: 'Bill of Materials' }]} />
                    ...
                    <CardHeader>
                        <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                            <div>
                                ...
                                <CardDescription>Component recipes for manufactured and kit products.</CardDescription>
                            </div>
